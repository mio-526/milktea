<script setup>
import { list,del } from "@/api/category/index.js";
...
const handleAdd = () => {
  router.push('/admin/addAndEdit/category')
}

const handleEdit = (row) => {
  router.push({path:'/admin/addAndEdit/category',query:{id:row.id}})
}
  ...
  <div>
    ...
    <el-form :model="queryParams" ref="queryFromRef" label-width="auto" :inline="true"  style="margin-top: 20px">
      <el-form-item label="类别名">
        <el-input v-model="queryParams.name" placeholder="请输入类别名" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="categoryList" ref="tableRef" style="margin-top: 20px;" row-key="id" v-loading="loading" @selection-change="handleSelectionChange">
